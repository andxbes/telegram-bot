...
function filter_messages(messages) {
    ...
    const true_words = [
        'грязно', 'грязь', 'крепят', 'чисто', 'чистота', 'чист', 'чизт', 'тихо', 'норм', 'в норме', 'ок', 'ok',
    ...
    const false_words = ['бля', 'желательно', 'в ахуе', 'чево', 'чего', 'шотак', 'вайб', 'почему', 'долбоеб', 'далбаеб', 'хуй'];
